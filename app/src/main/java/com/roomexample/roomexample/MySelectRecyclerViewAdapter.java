...
import com.roomexample.roomexample.SelectFragment.OnListFragmentInteractionListener;
...
public class MySelectRecyclerViewAdapter extends RecyclerView.Adapter<MySelectRecyclerViewAdapter.ViewHolder> {
    ...
    public MySelectRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
